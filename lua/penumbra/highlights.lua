...
hl.common = {
	...
	MatchParen = { fg = c.bg, bg = c.fg, fmt = "bold" },
	NonText = { fg = c.sky_m },
...
hl.plugins.mini = {
	...
	MiniHipatternsFixme = { fg = c.bg, bg = c.red, fmt = "bold" },
	MiniHipatternsHack = { fg = c.bg, bg = c.yellow, fmt = "bold" },
	MiniHipatternsNote = { fg = c.bg, bg = c.cyan, fmt = "bold" },
	MiniHipatternsTodo = { fg = c.bg, bg = c.purple, fmt = "bold" },

	MiniIconsAzure = { fg = c.cyan_c },
	MiniIconsBlue = { fg = c.blue },
	MiniIconsCyan = { fg = c.cyan },
	MiniIconsGreen = { fg = c.green },
	MiniIconsGrey = { fg = c.sky },
	...
	MiniJump2dSpotAhead = { fg = c.cyan, bg = c.bg, fmt = "nocombine" },
